...
/**
 * VITE_SUMBER_DATA=dummy → daftar wilayah, cabang, dan MO diambil dari src/data/dummy.ts,
 * tanpa memanggil backend sama sekali (dashboard tetap berjalan walau API tidak tersedia).
 */
export const PAKAI_DUMMY = import.meta.env.VITE_SUMBER_DATA === 'dummy';
